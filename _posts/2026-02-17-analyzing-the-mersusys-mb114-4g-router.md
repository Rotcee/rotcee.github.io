---
title: "Hardware Hacking: Analyzing the Mercusys MB115-4G router - Initial Recon"
date: 2026-02-17 
...
![Firmware versions](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/image.png)
...
![Contents of inittab](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/image-1.png){: width="70%"}
...
![Contents of passwd.bak](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/image-2.png){: width="70%"}
...
![Router front view](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/front.jpg)
*Figure 4: Router front view*

![Router back view](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/back.jpg)
...
![Router internals](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/inside.jpg)
*Figure 6: Router internals showing main components*

**1. Ethernet Transformer**:

![Ethernet transformer component](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/img3.jpg){: width="70%"}
...
![UART pinout identification](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/uarti-pinout.jpg){: width="70%"}
...
![SPI flash memory chip](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/img2.jpg){: width="70%"}
...
![4G LTE module](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/img1.jpg){: width="70%"}
...
![Soldered UART pins](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/uart-soldered.jpg){: width="70%"}
...
![UART connection diagram](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/uart-pins.png){: width="70%"}
*Figure 12: UART connection diagram*

![TTL-to-USB adapter](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/ttl-usb.jpg){: width="70%"}
...
![Boot logs showing console prompt](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/press-enter.png){: width="70%"}
...
![Failed login attempt](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/incorrect-login.png){: width="70%"}
*Figure 15: Failed login attempt*

Let's try with the credentials we saw in the **passwd.bak** file:

![Successful root login](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/correct-login.png){: width="70%"}
...
![Final setup with UART and LAN connection](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/final-setup.jpg)
*Figure 17: Final setup with UART and LAN connection*

Now let's enumerate all the system partitions (present in /proc/mtd):

![Flash memory partitions](/assets/img/blogs/2026-02-17-analyzing-the-mersusys-mb114-4g-router/flash-partitions.png){: width="70%"}
